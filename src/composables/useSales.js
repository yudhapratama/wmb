    ...
    try {
      ...
      if (currentSession.value) {
        const cleanSession = {
          ...
          modal_selisih: currentSession.value.modal_selisih,
          jumlah_tunai: currentSession.value.jumlah_tunai,
          selisih_tunai: currentSession.value.selisih_tunai,
          belanja_besok: currentSession.value.belanja_besok,
          setoran: currentSession.value.setoran,
          sisa_receh: currentSession.value.sisa_receh,
          notes: currentSession.value.notes,
          total_sales: currentSession.value.total_sales,
          total_hpp: currentSession.value.total_hpp,
          total_margin: currentSession.value.total_margin,
