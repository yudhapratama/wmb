      ...
      <div>
        ...
        <div class="flex flex-col sm:flex-row gap-2">
          <input
            ...
            class="w-full sm:flex-1 px-3 py-3 border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
